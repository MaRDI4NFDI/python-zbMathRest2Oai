...
API_SOURCE = 'https://api.zbmath.org/v1/document/6389213'


class PlainXmlTest(unittest.TestCase):
    def test_similarity(self):
        real_string = getAsXml.final_xml2(API_SOURCE, 'oai:zbmath.org:')[0]['oai:zbmath.org:6389213']

        ref_location = os.path.join(os.path.dirname(__file__), 'data/articles/invalid_chr.xml')
