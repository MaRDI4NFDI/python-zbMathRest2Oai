...
"zbMATH Open Web Interface contents unavailable due to conflicting licenses."</datacite:rights>
   ...
   <dc:format>application/xml</dc:format>
           ...
           <datacite:relatedIdentifiers>
            <!-- Apply templates for references with zbmath document_id or DOI as fallback -->
            <xsl:apply-templates select="//references"/>

            <!-- Process related identifiers (like ISSN) -->
...
with its own subjectscheme -->
    ...
    <xsl:template match="references">
        <xsl:if test="zbmath/document_id[normalize-space()]">
            <!-- If document_id is present and not empty -->
        ...
        <xsl:if test="not(zbmath/document_id[normalize-space()])">
            <!-- If document_id is empty or null -->
            <xsl:if test="doi[normalize-space()]">
                <datacite:relatedIdentifier relatedIdentifierType="DOI" relationType="Cites" resourceTypeGeneral="JournalArticle">
