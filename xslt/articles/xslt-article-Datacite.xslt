    ...
    <xsl:template match="source">
        ...
        <relatedItemIdentifier relatedItemIdentifierType="ISSN">
            ...
            <titles>
                <title>
                     <xsl:choose>
                    <xsl:when test="normalize-space(series/title) = '' or series/title = 'None' or series/title = 'none'">
            ...
            <lastPage>
              ...
              <publisher>
               <xsl:choose>
                <xsl:when test="normalize-space(series/publisher) = '' or series/publisher = 'None' or series/publisher = 'none'">
                    <xsl:text>:unav</xsl:text>
                </xsl:when>
                <xsl:otherwise>
