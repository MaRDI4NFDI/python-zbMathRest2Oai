        ...
        <resource
            ...
            <rightsList> <!-- this generates the copyrights and legal aspect wihtin the xslt -->
                <rights xml:lang="en"
                    ...
                    The zbMATH Open OAI-PMH API is subject to the Terms and Conditions for the zbMATH Open API Service
                    of FIZ Karlsruhe – Leibniz-Institut für Informationsinfrastruktur GmbH.
                    Content generated by zbMATH Open, such as reviews, classifications, software, or author
                    disambiguation data, are distributed under CC-BY-SA 4.0. This defines the license for the whole
                    dataset, which also contains non-copyrighted bibliographic metadata and reference data derived from
                    I4OC (CC0). Note that the API only provides a subset of the data in the zbMATH Open Web interface.
                    In several cases, third-party information, such as abstracts, cannot be made available under a
                    suitable license through the API. In those cases, we replaced the data with the string
        ...
        <relatedItem relationType="IsPublishedIn" relatedItemType="Book">
            ...
            <titles>
                <title>
                    <xsl:choose>
                        <xsl:when
                                test="normalize-space(series/title) = '' or series/title = 'None' or series/title = 'none'">
            ...
            <publicationYear>
                <xsl:choose>
                    <xsl:when test="normalize-space(series/year) = '' or series/year = 'None' or series/year = 'none'">
                        <xsl:text>:unav</xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
            ...
            <publisher>
                <xsl:choose>
                    <xsl:when
                            test="normalize-space(series/publisher) = '' or series/publisher = 'None' or series/publisher = 'none'">
                        <xsl:text>:unav</xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
